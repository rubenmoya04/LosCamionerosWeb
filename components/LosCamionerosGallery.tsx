...
export default function LosCamionerosGallery() {
  ...
  const galleryImages = useMemo(() => [
    ...
    },
    {
      ...
      title: "Los Camioneros",
      description: "El corazón de nuestra tradición",
      badge: "Favorito"
    }
  ], [])
  ...
  // Device detection con debouncing optimizado
  const getDeviceType = useCallback(() => {
    const { width, height } = viewport
    const isLandscape = width > height
    
    if (width < BREAKPOINTS.mobile) {
      return { type: 'mobile', orientation: isLandscape ? 'landscape' : 'portrait' }
    } else if (width < BREAKPOINTS.tablet) {
      return { type: 'tablet', orientation: isLandscape ? 'landscape' : 'portrait' }
    ...
    switch (device.type) {
      ...
      case 'small-desktop':
        return {
          ...
          subtitleSize: 'text-2xl lg:text-3xl',
      ...
      default:
        return {
          ...
          containerPadding: 'px-6 lg:px-8',
          titleSize: 'text-5xl lg:text-6xl xl:text-7xl',
          subtitleSize: 'text-2xl lg:text-3xl',
  ...
  // Viewport detection con debouncing
  useEffect(() => {
  ...
  // Auto-rotate testimonials con ajuste según dispositivo
  useEffect(() => {
    const interval = setInterval(() => {
      setCurrentTestimonial((prev) => (prev + 1) % testimonials.length)
    }, device.type === 'mobile' ? 6000 : 5000)

    return () => clearInterval(interval)
  }, [testimonials.length, device.type])
  ...
  }, [touchStart, touchEnd, testimonials.length])
  ...
  const containerVariants = useMemo(() => ({
    ...
    visible: {
      opacity: 1,
      transition: {
        staggerChildren: sizes.staggerDelay,
        delayChildren: 0.1,
      },
    },
  }), [sizes.staggerDelay])
      ...
      <motion.div variants={itemVariants} className="flex items-center justify-center mb-4 sm:mb-6 mt-[-30px]">
        <div className="relative">
          ...
          <div className="relative bg-gradient-to-r from-cyan-500 to-blue-400 p-3 sm:p-4 rounded-full shadow-2xl">
            <Camera className={sizes.iconSize + " text-white"} />
          </div>
        </div>
      </motion.div>
  ...
  ), [containerVariants, itemVariants, sizes, isVisible])
  ...
  ), [galleryImages, sizes.carouselHeight, openImageModal])
  ...
  return (
    <>
      ...
      <section
        ref={galleryRef}
        className={`relative ${sizes.sectionPadding} opacity-0 transition-opacity duration-1000`}
        id="galeria"
      >
        ...
        {isImageModalOpen && (
          ...
          >
            ...
            >
              ...
              <button
                onClick={closeImageModal}
                className="absolute top-2 right-2 bg-red-500/20 hover:bg-red-500/30 text-white p-2 rounded-full backdrop-blur-sm transition-all duration-300"
              >
                <X className="w-6 h-6" />
              </button>
      ...
      >
        <div className={`max-w-7xl mx-auto ${sizes.containerPadding} relative z-10`}>
          ...
          >
            <motion.div variants={itemVariants} className="flex items-center justify-center mb-4 sm:mb-6">
              <div className="relative">
                ...
                <div className="relative bg-gradient-to-r from-emerald-500 to-blue-400 p-3 sm:p-4 rounded-full shadow-2xl">
                  <ThumbsUp className={sizes.iconSize + " text-white"} />
                </div>
              </div>
            </motion.div>
            ...
            <motion.p
              variants={itemVariants}
              className={`${sizes.subtitleSize} text-gray-600 max-w-2xl mx-auto px-4 mt-8 font-bold`}
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
            {features.map((feature, index) => (
              <motion.div
                ...
                variants={itemVariants}
                whileHover={{
                  scale: device.type === 'mobile' ? 1.02 : 1.05,
                  y: device.type === 'mobile' ? -5 : -10
                }}
                ...
                `}>
                  ...
                  <div className="relative z-10 p-6 sm:p-8 md:p-10">
                    ...
                    <div className="text-center space-y-3 sm:space-y-4">
                      ...
                      `}>
                        {device.type === 'mobile' ? feature.mobileStat : feature.stat}
                      </div>
      ...
      <section
        ref={testimonialsRef}
        className={`relative ${sizes.sectionPadding} opacity-0 transition-opacity duration-1000 bg-gradient-to-br from-blue-50/40 via-cyan-50/30 to-emerald-50/40 backdrop-blur-sm`}
      >
        ...
        <div className={`max-w-7xl mx-auto ${sizes.containerPadding} relative z-10`}>
          ...
          >
            <motion.div variants={itemVariants} className="flex items-center justify-center mb-4 sm:mb-6">
              <div className="relative">
                ...
                <div className="relative bg-gradient-to-r from-orange-500 to-yellow-400 p-3 sm:p-4 rounded-full shadow-2xl">
                  <Quote className={sizes.iconSize + " text-white"} />
                </div>
              </div>
            </motion.div>
            ...
            <motion.h2
              variants={itemVariants}
              className={`${sizes.titleSize} font-bold bg-gradient-to-r from-blue-600 via-cyan-600 to-emerald-600 bg-clip-text text-transparent mb-4 sm:mb-6`}
            >
            ...
            <motion.p
              variants={itemVariants}
              className={`${sizes.subtitleSize} text-gray-600 max-w-2xl mx-auto px-4`}
            >
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <AnimatePresence mode="wait">
                ...
                >
                  <Card className={`${sizes.cardPadding} border border-blue-100/50 shadow-xl bg-gradient-to-br from-white/80 to-blue-50/60 backdrop-blur-md`}>
