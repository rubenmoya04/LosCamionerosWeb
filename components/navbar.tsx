      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
        <div className="flex justify-between items-center h-14 sm:h-16 md:h-18 lg:h-20">
          ...
          <div className="hidden md:flex lg:hidden items-center space-x-2 sm:space-x-3">
            ...
            >
              <Images className="h-5 w-5 text-slate-700 group-hover:text-blue-700" />
            </button>
            <button
              onClick={() => scrollToSection("platos")}
              className="p-2 rounded-lg hover:bg-slate-100 transition-all duration-300 group"
              aria-label="Platos"
            >
              <CookingPot className="h-5 w-5 text-slate-700 group-hover:text-blue-700" />
            </button>
            <button
              onClick={() => scrollToSection("footer")}
              className="p-2 rounded-lg hover:bg-slate-100 transition-all duration-300 group"
              aria-label="Contacto"
            >
              <BadgeInfo className="h-5 w-5 text-slate-700 group-hover:text-blue-700" />
            </button>
            {/* <Button
              onClick={() => scrollToSection("cartaPDF")}
              size="sm"
              className="bg-blue-900 hover:bg-blue-700 text-white transition-all duration-300 hover:scale-105"
